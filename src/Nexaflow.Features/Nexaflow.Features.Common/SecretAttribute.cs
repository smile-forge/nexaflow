...
/// next save). Mirrored in <c>Nexaflow.Providers.Common</c> so provider configs can use it without
/// crossing the layering (same precedent as <c>IConfigMigration</c>); Core matches by attribute name.
/// </summary>
