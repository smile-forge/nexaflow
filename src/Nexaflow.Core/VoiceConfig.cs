...
/// <summary>
/// General (non-WorkContext) voice-input settings. Registered manually in
/// App.xaml.cs; auto-surfaces in the Options panel as a "Voice" section with
/// the two enums rendered as combo boxes.
/// </summary>
