...
public partial class MarkdownView : UserControl
{
    ...
    /// <see cref="StyleFormat.FromTheme"/>; set <see cref="StyleFormat.Light"/> for fixed
    /// light surfaces (e.g. scratchpad post-its).</summary>
    public static readonly DependencyProperty PaletteProperty =
        DependencyProperty.Register(
            nameof(Palette), typeof(StyleFormat), typeof(MarkdownView),
    ...
    private void Rebuild()
    {
        ...
        foreach (var block in doc)
        {
            ...
            BlocksPanel.Children.Add(BlockRenderer.Render(block, blockRaw, Palette ?? StyleFormat.FromTheme()));
        }
    }
