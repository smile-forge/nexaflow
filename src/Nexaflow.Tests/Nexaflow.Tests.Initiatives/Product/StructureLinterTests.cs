...
/// <summary>
/// The advisory modelling-rule checks behind <c>nfi lint</c> (docs/product-graph.md and
/// docs/testing.md). The bar is the mirror of <see cref="SnaplinkValidatorTests"/>'s: this one must not cry wolf on a
