...
public class KanbanBoardTests
{
    ...
    {
        var board = KanbanBoard.Read(KanbanGrammarTests.Full);
    ...
    {
        var card = KanbanBoard.Read(KanbanGrammarTests.Full).Columns[3].Cards[0];
