...
public class GanttChartTests
{
    ...
    {
        var chart = GanttChart.Read(GanttGrammarTests.First, Today);
    ...
    {
        var chart = GanttChart.Read(GanttGrammarTests.Syntax, Today);
    ...
    public void ExcludedDaysPushALengthsEndOn_ButNotADatesEnd()
    {
        ...
        var friday = GanttChart.Read("gantt\n  excludes weekends\n  weekend friday\n  includes 2014-01-11\n  Task : 2014-01-01, 1d", Today);
