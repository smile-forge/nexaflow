...
| a Mermaid diagram — adding one on the shared layout tree, or anything under `Markdown/Mermaid` | [docs/mermaid-diagrams.md](docs/mermaid-diagrams.md) · the `mermaid-diagram` skill |
